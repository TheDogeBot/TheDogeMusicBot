# DogeTheMusicBot (Telegram bot project)
...
from DogeTheMusicBot.modules.play import generate_cover
from DogeTheMusicBot.modules.play import arq
from DogeTheMusicBot.modules.play import cb_admin_check
from DogeTheMusicBot.modules.play import transcode
from DogeTheMusicBot.modules.play import convert_seconds
from DogeTheMusicBot.modules.play import time_to_seconds
from DogeTheMusicBot.modules.play import changeImageSize
from DogeTheMusicBot.config import BOT_NAME as bn
from DogeTheMusicBot.config import DURATION_LIMIT
from DogeTheMusicBot.config import UPDATES_CHANNEL as updateschannel
from DogeTheMusicBot.config import que
from DogeTheMusicBot.function.admins import admins as a
from DogeTheMusicBot.helpers.errors import DurationLimitError
from DogeTheMusicBot.helpers.decorators import errors
from DogeTheMusicBot.helpers.admins import get_administrators
from DogeTheMusicBot.helpers.channelmusic import get_chat_id
from DogeTheMusicBot.helpers.decorators import authorized_users_only
from DogeTheMusicBot.helpers.filters import command
from DogeTheMusicBot.helpers.filters import other_filters
from DogeTheMusicBot.helpers.gets import get_file_name
from DogeTheMusicBot.services.callsmusic import callsmusic
from DogeTheMusicBot.services.callsmusic import client as USER
from DogeTheMusicBot.services.converter.converter import convert
from DogeTheMusicBot.services.downloaders import youtube
from DogeTheMusicBot.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @DogeTheMusicBot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
